...
public class Project {
    ...
    public Project(Integer id, String name, String identifier, String description, String homepage, Integer status,
                   Boolean is_public, Boolean inherit_members, String created_on, String updated_on) {
        this.id = id;
        this.name = name;
